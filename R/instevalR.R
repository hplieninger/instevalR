...
#' @section Workflow:
#' \enumerate{
#'  \item{You have \code{R} and \code{instevalR} installed. Furthermore, please download the files of your course evaluations (InstEvaL -> Results -> Raw data) and put them into a single directory.}
