...
* The *.csv-files of your course evaluations, which you can downlaod from insteval (-> Results -> Raw data). Please save all your *.csv-files in a single directory.
* R (which you can download from http://www.r-project.org)
* The package `instevalR`
